...
import com.asialjim.microapplet.web.sensitive.annotation.Sensitive;
...
public abstract class SensitiveHandler {
    ...
    public static String mask(Sensitive sensitive, String source) {
        ...
        return mask(type, source, sensitive.prefix(), sensitive.suffix(), sensitive.regex(), sensitive.match(), handler.function());
    }
    ...
    private static String maskWithIndex(String s, int prefix, int suffix) {
